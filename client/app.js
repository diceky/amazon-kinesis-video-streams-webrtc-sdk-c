const myAccessKeyId = "your-access-key-ID";
const mySecretAccessKey = "your-secret-access-key";
const myChannelName = "your-channel-name";
...
document.getElementById("forward").addEventListener("pointerdown", function () {
  sendForward();
});
document.getElementById("forward").addEventListener("pointerup", function () {
  sendStop();
});
...
document.getElementById("left").addEventListener("pointerup", function () {
  sendStop();
});
...
document.getElementById("right").addEventListener("pointerup", function () {
  sendStop();
});

document.getElementById("back").addEventListener("pointerdown", function () {
  sendBack();
});
...
document.getElementById("speed").onchange = function () {
  sendViewerMessage(document.getElementById("speed").value);
};
